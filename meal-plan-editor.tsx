...
import { CalendarDays, ChefHat, AlertCircle, Download, Search, Plus, Trash2, CheckCircle, XCircle, Menu } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <DndContext sensors={sensors} onDragStart={handleDragStart} onDragEnd={handleDragEnd}>
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          {/* Recipe Library - Desktop (Sticky) */}
          <Card className="hidden lg:block lg:col-span-1 sticky top-6 self-start">
            <CardHeader>
          ...
          {/* Mobile Recipe Sheet Button */}
          <Sheet open={isRecipeSheetOpen} onOpenChange={setIsRecipeSheetOpen}>
            <SheetTrigger asChild>
              <Button 
                className="lg:hidden fixed bottom-6 right-6 rounded-full w-14 h-14 shadow-lg z-50"
                size="icon"
              >
